...
class TransactionConfigurationTypeAlias(object):
    ...
    def __init__(self, type=None, description=None, transaction_class=None, transaction_group=None, transaction_roles=None, is_default=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param is_default:  IsDefault is a flag that denotes the default alias for a group
    ...
    def is_default(self):
        ...
        IsDefault is a flag that denotes the default alias for a group  # noqa: E501
