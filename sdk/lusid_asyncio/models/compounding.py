...
class Compounding(object):
    ...
    def __init__(self, compounding_method=None, reset_frequency=None, spread_compounding_method=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param spread_compounding_method:  Defines how the computed leg spread is applied to compounded rate.  It applies only when CompoundingMethod = ‘Compounded‘.  Supported string (enumeration) values are: [IsdaCompounding, NoCompounding, IsdaFlatCompounding, None]. (required)
    ...
    def spread_compounding_method(self):
        ...
        Defines how the computed leg spread is applied to compounded rate.  It applies only when CompoundingMethod = ‘Compounded‘.  Supported string (enumeration) values are: [IsdaCompounding, NoCompounding, IsdaFlatCompounding, None].  # noqa: E501
