...
class ExecutionRequest(object):
    ...
    def __init__(self, id=None, placement_id=None, properties=None, instrument_identifiers=None, quantity=None, state=None, side=None, type=None, created_date=None, settlement_date=None, price=None, settlement_currency=None, settlement_currency_fx_rate=None, counterparty=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type price: lusid_asyncio.CurrencyAndAmount
