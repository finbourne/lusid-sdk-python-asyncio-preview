...
class LegDefinition(object):
    ...
    required_map = {
        ...
        'index_convention_name': 'required',
    ...
    def __init__(self, convention_name=None, conventions=None, index_convention=None, index_convention_name=None, notional_exchange_type=None, pay_receive=None, rate_or_spread=None, reset_convention=None, stub_type=None, compounding=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param index_convention_name:  (required)
    ...
    def index_convention_name(self, index_convention_name):
        ...
        :type index_convention_name: lusid_asyncio.FlowConventionName
        """
        if self.local_vars_configuration.client_side_validation and index_convention_name is None:  # noqa: E501
            raise ValueError("Invalid value for `index_convention_name`, must not be `None`")  # noqa: E501
    ...
    def compounding(self, compounding):
        ...
        :type compounding: lusid_asyncio.Compounding
        """
        if self.local_vars_configuration.client_side_validation and compounding is None:  # noqa: E501
            raise ValueError("Invalid value for `compounding`, must not be `None`")  # noqa: E501
