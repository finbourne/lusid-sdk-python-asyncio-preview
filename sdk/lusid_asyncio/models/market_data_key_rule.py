...
class MarketDataKeyRule(object):
    ...
    def data_scope(self, data_scope):
        ...
        if (self.local_vars_configuration.client_side_validation and
                data_scope is not None and len(data_scope) > 64):
            raise ValueError("Invalid value for `data_scope`, length must be less than or equal to `64`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def price_source(self, price_source):
        ...
        if (self.local_vars_configuration.client_side_validation and
                price_source is not None and not re.search(r'^[a-zA-Z0-9\-_]+$', price_source)):  # noqa: E501
            raise ValueError(r"Invalid value for `price_source`, must be a follow pattern or equal to `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
