...
class CdsProtectionDetailSpecification(object):
    ...
    def seniority(self, seniority):
        ...
        if self.local_vars_configuration.client_side_validation and seniority not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def restructuring_type(self, restructuring_type):
        ...
        if self.local_vars_configuration.client_side_validation and restructuring_type not in allowed_values:  # noqa: E501
            raise ValueError(
