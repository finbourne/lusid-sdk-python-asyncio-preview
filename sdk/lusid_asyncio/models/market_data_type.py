...
class MarketDataType(object):
    ...
    allowable_values = [DISCOUNTFACTORCURVEDATA, EQUITYVOLSURFACEDATA, FXVOLSURFACEDATA, IRVOLCUBEDATA, OPAQUEMARKETDATA, YIELDCURVEDATA, FXFORWARDCURVEDATA, FXFORWARDPIPSCURVEDATA, FXFORWARDTENORCURVEDATA, FXFORWARDTENORPIPSCURVEDATA, FXFORWARDCURVEBYQUOTEREFERENCE, CREDITSPREADCURVEDATA]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """MarketDataType - a model defined in OpenAPI"
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketDataType):
            return False
