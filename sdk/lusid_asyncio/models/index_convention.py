...
class IndexConvention(object):
    ...
    def __init__(self, fixing_reference=None, publication_day_lag=None, payment_tenor=None, day_count_convention=None, currency=None, scope=None, code=None, local_vars_configuration=None):  # noqa: E501
