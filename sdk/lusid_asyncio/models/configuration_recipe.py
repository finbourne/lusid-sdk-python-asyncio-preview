...
class ConfigurationRecipe(object):
    ...
    def __init__(self, scope=None, code=None, holding=None, market=None, pricing=None, aggregation=None, inherited_recipes=None, description=None, local_vars_configuration=None):  # noqa: E501
