...
class CreditSpreadCurveData(object):
    ...
    def __init__(self, base_date=None, dom_ccy=None, recovery_rate=None, spreads=None, tenors=None, market_data_type=None, local_vars_configuration=None):  # noqa: E501
