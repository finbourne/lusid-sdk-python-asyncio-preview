...
class CreditSpreadCurveData(object):
    ...
    def __init__(self, base_date=None, dom_ccy=None, tenors=None, spreads=None, recovery_rate=None, market_data_type=None, local_vars_configuration=None):  # noqa: E501
