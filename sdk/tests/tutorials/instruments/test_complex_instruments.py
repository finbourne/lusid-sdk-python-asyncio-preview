...
class ComplexInstrumentTests(asynctest.TestCase):
    ...
    async def test_create_fx_forward(self):
    ...
    async def test_create_fx_option(self):
    ...
    async def test_create_term_deposit(self):
    ...
    async def test_create_zero_coupon_bond(self):
