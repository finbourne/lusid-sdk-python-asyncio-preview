...
class Portfolios(asynctest.TestCase):
    ...
    @lusid_feature("F9")
    async def test_create_portfolio_with_properties(self):
        guid = str(uuid.uuid4())
    ...
    @lusid_feature("F10")
    async def test_add_transaction_to_portfolio(self):
    ...
    @lusid_feature("F11")
    async def test_add_transaction_to_portfolio_with_property(self):
        guid = str(uuid.uuid4())
