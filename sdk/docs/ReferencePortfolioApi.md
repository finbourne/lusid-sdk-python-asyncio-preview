# lusid_asyncio.ReferencePortfolioApi
...
with lusid_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = lusid_asyncio.ReferencePortfolioApi(api_client)
    scope = 'scope_example' # str | The scope in which to create the reference portfolio.
create_reference_portfolio_request = {"displayName":"MyPortfolioName","description":"Description of my portfolio","code":"MyPortfolioCode","created":"2018-03-05T00:00:00.0000000+00:00","properties":{},"instrumentScopes":[]} # CreateReferencePortfolioRequest | The definition of the reference portfolio.
