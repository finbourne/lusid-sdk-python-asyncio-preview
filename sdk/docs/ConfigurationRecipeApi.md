# lusid_asyncio.ConfigurationRecipeApi
...
with lusid_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = lusid_asyncio.ConfigurationRecipeApi(api_client)
